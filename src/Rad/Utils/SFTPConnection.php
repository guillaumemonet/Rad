...
class SFTPConnection {
    ...
    public function login(string $username, string $password): void {
        @ssh2_auth_password($this->connection, $username, $password) || $this->throwError("Could not authenticate with username $username.");
     ...
     * @throws ErrorException
     */
    public function uploadFile(string $local_file, string $remote_file): void {
     ...
     * @throws ErrorException
     */
    public function downloadFile(string $local_file, string $remote_file): void {
