...
class Column {
    ...
    private function generateFormatTab() {
        return [
            ...
            "bind"       => '":' . $this->name . '"' . ' => ' . ($this->type_php == 'bool' ? 'intval(' . $this->name . ')' : '(' . $this->type_php . ') $' . $this->name),
            "bind_this"  => '":' . $this->name . '"' . ' => ' . ($this->type_php == 'bool' ? 'intval($this->' . $this->name . ')' : '(' . $this->type_php . ') $this->' . $this->name),
            "this"       => '$this->' . $this->name
        ];
    }
